...
os.makedirs("dalek_images_hq", exist_ok=True)
...
response = requests.get("https://tardis.fandom.com/wiki/Dalek/Gallery", headers=headers, timeout=30)
...
for idx, a in enumerate(image_links, 1):
    try:
        ...
        # Fandom format: https://static.wikia.nocookie.net/tardis/images/thumb/X/XX/Filename.ext/revision/latest/scale-to-width-down/250?cb=...
        # We want: https://static.wikia.nocookie.net/tardis/images/X/XX/Filename.ext
        
        if "static.wikia" in img_url or "vignette.wikia" in img_url:
            # Remove everything after the actual filename
            # Find the pattern: /images/... or /images/thumb/...
        ...
        if img_response.status_code == 200:
            ...
            filename = f"dalek_images_hq/dalek_{idx:04d}{ext}"
